...
def evaluateExpression(expression):
    ...
    This function takes a mathematical expression as input,
    evaluates it using the `eval()` function,
    and returns the result as a string. If an error occurs during evaluation,
